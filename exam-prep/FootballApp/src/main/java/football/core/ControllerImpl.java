...
public class ControllerImpl implements Controller {
    ...
    public String supplementForField(String fieldName, String supplementType) {
        ...
        if (s == null) {
            throw new IllegalArgumentException(NO_SUPPLEMENT_FOUND);
        }
    ...
    public String addPlayer(String fieldName, String playerType, String playerName, String nationality, int strength) {
        ...
        if (!playerCanPlayInField(playerType, field)) {
    ...
    private boolean playerCanPlayInField(String playerType, Field field) {

        String fieldType = field.getClass().getSimpleName();
        boolean canPlayOnField = playerType.equals("Women") && fieldType.equals("ArtificialTurf");

        if (!canPlayOnField) {
            canPlayOnField = playerType.equals("Men") && fieldType.equals("NaturalGrass");
        }

        return canPlayOnField;
    }
